  ...
  >
    ...
    <v-spacer></v-spacer>
    <v-btn class="rounded-xl pa-5" min-width="0" text to="/">
      Home
      <v-icon>mdi-home-circle</v-icon>
    </v-btn>

    <v-spacer></v-spacer>
    <v-btn class="rounded-xl pa-5" min-width="0" text to="/badge-factory">
      Badge Factory
    ...
    <v-btn class="rounded-xl pa-5" min-width="0" text to="/badges">
      Badges
    ...
    <v-btn class="rounded-xl pa-5" min-width="0" text to="/community">
      Community
